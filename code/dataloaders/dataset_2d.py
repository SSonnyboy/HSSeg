...
#     def __init__(
#         self, output_size, cutout_prob=0.5, n_holes=3, cutout_length_range=(10, 30)
#     ):
#         self.output_size = output_size
#         self.cutout_prob = cutout_prob
#         self.n_holes = n_holes
#         self.cutout_length_range = cutout_length_range
...
#         # apply random cutout as a geometric transformation
#         image, label = random_cutout(
#             image,
#             label,
#             n_holes=self.n_holes,
#             length_range=self.cutout_length_range,
#             prob=self.cutout_prob,
#         )
...
# def random_cutout(image, label, n_holes=3, length_range=(10, 30), prob=0.5):
#     """
#     在图像和标签上同时应用随机cutout变换

#     Args:
#         image: 输入图像
#         label: 输入标签/mask
#         n_holes: 要剪切的区域数量
#         length_range: 剪切区域边长范围 (min, max)
#         prob: 应用cutout的概率
...
#         # 随机确定cutout区域的位置
#         y = np.random.randint(h - length + 1)
#         x = np.random.randint(w - length + 1)

#         # 应用cutout（将区域设为0）
#         image_cutout[y : y + length, x : x + length] = 0
#         label_cutout[y : y + length, x : x + length] = 0

#     return image_cutout, label_cutout
