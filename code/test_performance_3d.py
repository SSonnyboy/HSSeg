...
parser.add_argument(
    "--flag_check_with_last", default=False, action="store_true", help=""
)
...
if FLAGS.flag_check_with_last:
    test_save_path = "{}/{}_{}_labeled/{}_predictions_last/".format(
        FLAGS.res_path, FLAGS.exp, FLAGS.labeled_num, FLAGS.model
    )
else:
    test_save_path = "{}/{}_{}_labeled/{}_predictions_best/".format(
        FLAGS.res_path, FLAGS.exp, FLAGS.labeled_num, FLAGS.model
    )
...
if flag_pancreas:
    ...
    image_list = [
        os.path.join(FLAGS.root_path, "data", f"{item}_norm.h5") for item in image_list
    ]
else:
    image_list = [
